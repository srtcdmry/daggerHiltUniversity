package com.ravish.daggerHiltUniversity.ui;
...
import com.daggerHiltUniversity.R;
import com.ravish.daggerHiltUniversity.adapter.UniversityAdapter;
import com.ravish.daggerHiltUniversity.database.UniversityEntity;
import com.ravish.daggerHiltUniversity.model.University;
import com.ravish.daggerHiltUniversity.viewModel.UniversityViewModel;

import java.util.List;

import dagger.hilt.android.AndroidEntryPoint;

@AndroidEntryPoint // bağımlılıklar enjekte ediliyor.
public class MainActivity extends AppCompatActivity {
    ...
    private void fetchUniversityData(){
        mViewModel.getAllUniversities("Turkey");
